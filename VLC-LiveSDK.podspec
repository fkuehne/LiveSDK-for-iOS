Pod::Spec.new do |s|
  ...
  s.public_header_files = "src/LiveSDK/Library/Public/*.h", "src/LiveSDK/Library/Internal/Helpers/LiveApiHelper.h", "src/LiveSDK/Library/Internal/LiveAuthStorage.h"
